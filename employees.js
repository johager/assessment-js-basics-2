...
console.log("empOne.name:", empOne.name)
...
const cece = new Employee('Cece','some times')
const schmidt = new Employee('Schmidt','other times')

const winston = new Manager('Winston', '24/7', [cece, schmidt])
